...
public class DesigneMoteure extends JFrame {
    ...
    public DesigneMoteure() {
        ...
        try {
            ...
            bouton3.setIcon(ic4);
            Image ig7 = ImageIO.read(new File("C:\\Users\\Lenovo\\Desktop/add.jfif"));
    ...
    public void RechercheImage() {
        ...
        try {
            ...
            if (methodemtree == 1) {
                structuremtree.RangQeuries(Query, 0.00035);
    ...
    public static void main(String[] args) {
        DesigneMoteure m = new DesigneMoteure();
